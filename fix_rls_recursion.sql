...
-- Breaks the cycle by using a SECURITY DEFINER helper function for authorization checks

-- Create helper function to check room membership with SECURITY DEFINER to avoid recursion
